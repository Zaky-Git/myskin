        ...
        confirmAlert({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    onClick: async () => {
                        try {
                            const response = await axiosClient.put(`/verifikasi-pengguna/${userId}`);
        ...
        <div className="dashboard-content container">
            ...
            <div className="card-custom shadow-xl p-3 mt-4">
                ...
                <div className="mb-4">
                    ...
                    <button
                        className={`btn ml-2 ${filter === "pasien" ? "btn-primary" : "btn-secondary"}`}
                        onClick={() => handleFilterChange("pasien")}
                    >
                        Pasien
                    </button>
                    <button
                        className={`btn ml-2 ${filter === "dokter" ? "btn-primary" : "btn-secondary"}`}
